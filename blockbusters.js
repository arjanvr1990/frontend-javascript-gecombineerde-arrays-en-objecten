...
const movieInfo = (movies.length-1);
...
const lastActor = (movies[movieInfo].actors.length-1);
console.log(lastActor);
console.log(movies[movieInfo].actors[lastActor])
...
const selectedMoviee = movies[5];
if (selectedMoviee.rating > 8) {
  console.log("Topper!");
} else if ((selectedMoviee.rating < 8) && (selectedMoviee.rating > 6.2)) {
  console.log("kijktip!");
} else {
